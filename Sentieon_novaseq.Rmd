...
def reformat_vcf(vcf_df, version):
  ...
  if version == 2:
    ...
    vcf_df['DP_FORMAT'] = vcf_df['SAMPLE'].str.split(':', expand=True)[3]
...
```{r , echo=FALSE}
setwd("~/Documents/Projects/myeloid/1.9.0/sentieon")
getwd()
```
...
ggplot(vcfsmerged, aes(x = DP_v2, y = DP_v3)) +
    ...
    labs(title = "Oncospan_1st_S39_L001")
...
ggplot(vcfsmerged, aes(x = AF_x, y = AF_y)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
   labs(x = "Sentieon 2.1.0 AF", y = "Sentieon 3.2.0 AF", title = "Oncospan_1st_S39_L001")
```
...
```{python}
vcf3_df_unique = vcf3_df.loc[-vcf3_df['site'].isin(common_sites)]
print("All v3 variants:" + str(len(vcf3_df)))
print("All unique v3 variants:" + str(len(vcf3_df_unique)))

vcf2_df_unique = vcf2_df.loc[-vcf2_df['site'].isin(common_sites)]
...
lowvcf2uniqAF_droppedinv3 = vcf2_AF_uniq.loc[~vcf2_AF_uniq['site_ref'].isin(vcf3_withvcf2uniqAF.site_ref)]
```
...
lowvcf2uniqAF_droppedinv3 <- py$lowvcf2uniqAF_droppedinv3
print(c("Number of variants that dropped from sentieon v3 but previously had low AF in sentieon v2: ", nrow(lowvcf2uniqAF_droppedinv3)))
lowvcf2uniqAF_droppedinv3
```
...
knitr::include_graphics("novaseq/bam_2.1.0/vcf_2.1.0/number-of-substitutions-of-snps-v2-oncospan-1st.col.png")
knitr::include_graphics("novaseq/bam_2.1.0/vcf_3.2.0/number-of-substitutions-of-snps-v3-oncospan-1st.col.png")
```
...
```{r, echo=FALSE,  out.width="50%", fig.align="default"}
knitr::include_graphics("novaseq/bam_2.1.0/vcf_2.1.0/types-of-variants-on-each-chromosome-v2-oncospan-1st.col.png")
knitr::include_graphics("novaseq/bam_2.1.0/vcf_3.2.0/types-of-variants-on-each-chromosome-v3-oncospan-1st.col.png")
```
...
ggplot(vcf3_ON_df) + 
  ...
  labs(title = "Sentieon v3 shared AF distribution: Oncospan_1st_S39_L001")
...
# variants in vcf3 that have gone from over 3% in v2 to under 3% in v3
vcf3_withvcf2uniqAF_formatted = vcf3_withvcf2uniqAF

# variants in vcf2 that have gone from over 3% in v2 to under 3% in v3
vcf2_withvcf2uniqAF_formatted = vcf2_withvcf2uniqAF

# variants in vcf2 that have gone from over 3% in v2 to disappearing in vcf v3
lowvcf2uniqAF_droppedinv3_formatted = lowvcf2uniqAF_droppedinv3
...
vcf2_df <- py$vcf2_df
vcf3_df <- py$vcf3_df
vcf3_withvcf2uniqAF_formatted <- py$vcf3_withvcf2uniqAF_formatted
vcf2_withvcf2uniqAF_formatted <- py$vcf2_withvcf2uniqAF_formatted
lowvcf2uniqAF_droppedinv3_formatted <- py$lowvcf2uniqAF_droppedinv3_formatted

cols.num <- c("AF_v2", "AF_byreads_v2" , "AF_v3", "AF_byreads_v3" )
vcfsmerged[cols.num] <- sapply(vcfsmerged[cols.num],as.numeric)
cols.num <- c("AF_v2", "AF_byreads_v2")
vcf2_df[cols.num] <- sapply(vcf2_df[cols.num],as.numeric)
cols.num <- c("AF_v3", "AF_byreads_v3")
vcf3_df[cols.num] <- sapply(vcf3_df[cols.num],as.numeric)
cols.num <- c("AF_v3", "AF_byreads_v3" )
vcf3_withvcf2uniqAF_formatted[cols.num] <- sapply(vcf3_withvcf2uniqAF_formatted[cols.num],as.numeric)
cols.num <- c("AF_v2", "AF_byreads_v2" )
vcf2_withvcf2uniqAF_formatted[cols.num] <- sapply(vcf2_withvcf2uniqAF_formatted[cols.num],as.numeric)
cols.num <- c("AF_v2", "AF_byreads_v2" )
lowvcf2uniqAF_droppedinv3_formatted[cols.num] <- sapply(lowvcf2uniqAF_droppedinv3_formatted[cols.num],as.numeric)


vcfmerged_lowvafinv3 <- vcfsmerged[which(vcfsmerged$site %in% vcf3_withvcf2uniqAF_formatted$site), ]
grob1 = grobTree(textGrob(paste("Pearson Corr: ", round(cor(vcfsmerged$AF_v2, vcfsmerged$AF_v3,use = "complete.obs"), 4) ), x = 0.63, y = 0.97, hjust = 0, gp = gpar(col = "red", fontsize = 11, fontface = "bold")))
ggplot(vcfsmerged, aes(x = AF_v2, y = AF_v3)) +
    geom_point() +
    geom_smooth() +
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Mutect2 AF v2", y = "Mutect2 AF v3")

ggplot(vcfsmerged, aes(x = AF_v2, y = AF_v3)) +
    geom_point() +
    geom_point(data=vcfmerged_lowvafinv3, aes(x=AF_v2, y=AF_v3), colour="red") +
    geom_smooth() +
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Mutect2 AF v2", y = "Mutect2 AF v3")
...
## mutect2 AF vs raw AF vcf v2
grob1 = grobTree(textGrob(paste("Pearson Corr: ", round(cor(vcf2_df$AF_byreads_v2, vcf2_df$AF_v2,use = "complete.obs"), 4) ), x = 0.63, y = 0.97, hjust = 0, gp = gpar(col = "red", fontsize = 11, fontface = "bold")))
ggplot(vcf2_df, aes(x = AF_byreads_v2, y = AF_v2)) +
    geom_point() +
    geom_point(data=vcf2_withvcf2uniqAF_formatted, aes(x=AF_byreads_v2, y=AF_v2), colour="blue") +
    geom_point(data=lowvcf2uniqAF_droppedinv3_formatted, aes(x=AF_byreads_v2, y=AF_v2), colour="red") +
    geom_smooth() +
    geom_abline() +
    annotation_custom(grob1) + 
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v2.1.0")
...
## mutect2 AF vs raw AF vcf v3
grob1 = grobTree(textGrob(paste("Pearson Corr: ", round(cor(vcf3_df$AF_byreads_v3, vcf3_df$AF_v3,use = "complete.obs"), 4) ), x = 0.63, y = 0.97, hjust = 0, gp = gpar(col = "red", fontsize = 11, fontface = "bold")))
ggplot(vcf3_df, aes(x = AF_byreads_v3, y = AF_v3)) +
    geom_point() +
    geom_smooth() +
    geom_abline() +
    annotation_custom(grob1) +
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v3.2.0")
...
## raw AF vcf v2 vs raw AF vcf v3
grob1 = grobTree(textGrob(paste("Pearson Corr: ", round(cor(vcfsmerged$AF_byreads_v2, vcfsmerged$AF_byreads_v3,use = "complete.obs"), 4) ), x = 0.63, y = 0.97, hjust = 0, gp = gpar(col = "red", fontsize = 11, fontface = "bold")))
ggplot(vcfsmerged, aes(x = AF_byreads_v2, y = AF_byreads_v3)) +
    geom_point() +
    geom_smooth() +
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Raw AF sentieon v2", y = "Raw AF sentieon v3")
...
## Plot the DPs of the 
vcfsmerged$DP_v2<-as.numeric(gsub("DP=","",as.character(vcfsmerged$DP_v2)))
vcfsmerged$DP_v3<-as.numeric(gsub("DP=","",as.character(vcfsmerged$DP_v3)))

ggplot(vcfsmerged, aes(x = DP_v2, y = DP_v3)) +
    geom_point() +
    geom_smooth() +
    geom_abline() +
    labs(x = "DP sentieon v2", y = "DP sentieon v3") 
```
...
ggplot(vcfsmerged, aes(x = AF_x, y = AF_y)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Sentieon 2.1.0 AF", y = "Sentieon 3.2.0 AF", title = "Oncospan_2nd_S40")
```
...
vcf2 = 'novaseq/bam_2.1.0/vcf_2.1.0/TMv2OCT20-oncospan-cell-line-2nd_S40_L001_filteredmyeo_goodAF.vcf'
vcf3 = 'novaseq/bam_2.1.0/vcf_3.2.0/TMv2OCT20-oncospan-cell-line-2nd_S40_L001_filteredmyeo_goodAF.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
...
common_sites = common_elements(vcf2_df.site,vcf3_df.site_ref)
print("Number of Chrom:Pos sites shared between two vcfs: " + str(len(common_sites))) # 196,147
...
# read in vcf3 all
vcf3 = 'novaseq/bam_2.1.0/vcf_3.2.0/TMv2OCT20-oncospan-cell-line-2nd_S40_L001_filteredmyeo.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
vcf3_df = pd.read_csv( vcf3, sep="\t", comment='#', 
                    names=cols, compression='infer')
vcf3_df = reformat_vcf(vcf3_df, 3)
...
# filter the vcf3 for sites in vcf2_AF_uniq
vcf3_withvcf2uniqAF = vcf3_df.loc[vcf3_df['site_ref'].isin(vcf2_AF_uniq.site)]

# there 25 variants carried over vcf3 with lower AF but there is 17 variants not called in sentieon v3. These are:
lowvcf2uniqAF_droppedinv3 = vcf2_AF_uniq.loc[~vcf2_AF_uniq['site_ref'].isin(vcf3_withvcf2uniqAF.site)]
```
...
# read in vcf2 all
vcf2 = 'novaseq/bam_2.1.0/vcf_2.1.0/TMv2OCT20-oncospan-cell-line-2nd_S40_L001_filteredmyeo.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
vcf2_df = pd.read_csv( vcf2, sep="\t", comment='#', 
                    names=cols, compression='infer')
...
# filter the vcf2 for sites in vcf2_AF_uniq
vcf2_withvcf3uniqAF = vcf2_df.loc[vcf2_df['site_ref'].isin(vcf3_AF_uniq.site)]
print("Uniq sites in vcf sentieon v2 in sentieon v3 but at low AF")
vcf2_withvcf3uniqAF  

# get unique sites not called
lowvcf2uniqAF_droppedinv3 = vcf3_AF_uniq.loc[~vcf3_AF_uniq['site_ref'].isin(vcf3_withvcf2uniqAF.site)]
...
```{r, echo=FALSE,  out.width="50%", fig.align="default"}
knitr::include_graphics("novaseq/bam_2.1.0/vcf_2.1.0/number-of-substitutions-of-snps-v2-oncospan-2nd.col.png")
knitr::include_graphics("novaseq/bam_2.1.0/vcf_3.2.0/number-of-substitutions-of-snps-v3-oncospan-2nd.col.png")
```
...
```{r, echo=FALSE,  out.width="50%", fig.align="default"}
knitr::include_graphics("novaseq/bam_2.1.0/vcf_2.1.0/types-of-variants-on-each-chromosome-v2-oncospan-2nd.col.png")
knitr::include_graphics("novaseq/bam_2.1.0/vcf_3.2.0/types-of-variants-on-each-chromosome-v3-oncospan-2nd.col.png")
```
...
print("Number of variants in control that is vcf v2:: " + str(len(vcf2_ON_df)))
print("Number of variants in control that is vcf v23: " + str(len(vcf3_ON_df)))
...
ggplot(vcf2_ON_df) + 
  geom_density(aes(x = vcf2_ON_df$AF_v2), color = "blue") + 
  geom_density(aes(x = vcf2_ON_df$EXP_AF), color = "red") +
  labs(title = "Sentieon v2 shared AF distribution Oncospan_2nd_S40")

ggplot(vcf3_ON_df) + 
  geom_density(aes(x = vcf3_ON_df$AF_v3), color = "blue") + 
  geom_density(aes(x = vcf3_ON_df$EXP_AF), color = "red") +
  labs(title = "Sentieon v3 shared AF distribution Oncospan_2nd_S40")
...
```{python}
vcf2 = 'novaseq/bam_2.1.0/vcf_2.1.0/TMv2OCT20-HD734-1st_S35_L001_filteredmyeo.vcf'
vcf3 = 'novaseq/bam_2.1.0/vcf_3.2.0/TMv2OCT20-HD734-1st_S35_L001_filteredmyeo.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
...
# save common snps
vcfs_merged = pd.merge(vcf2_df_common, vcf3_df_common, on='site')
```
...
ggplot(vcfsmerged, aes(x = AF_x, y = AF_y)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Sentieon 2.1.0 AF", y = "Sentieon 3.2.0 AF")
```
...
vcf2 = 'novaseq/bam_2.1.0/vcf_2.1.0/TMv2OCT20-HD734-1st_S35_L001_filteredmyeo_goodAF.vcf'
vcf3 = 'novaseq/bam_2.1.0/vcf_3.2.0/TMv2OCT20-HD734-1st_S35_L001_filteredmyeo_goodAF.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
...
# save common snps
vcfs_merged = pd.merge(vcf2_df_common, vcf3_df_common, on='site')
vcfs_merged.to_csv('Merged_vcfs_common.tsv', sep="\t", index=False, header=True)
```
...
```{r, echo=FALSE,  out.width="50%", fig.align="default"}
knitr::include_graphics("novaseq/bam_2.1.0/vcf_2.1.0/number-of-substitutions-of-snps-v2-hd734.col.png")
knitr::include_graphics("novaseq/bam_2.1.0/vcf_3.2.0/number-of-substitutions-of-snps-v3-hd734.col.png")
```
...
```{r, echo=FALSE,  out.width="50%", fig.align="default"}
knitr::include_graphics("novaseq/bam_2.1.0/vcf_2.1.0/types-of-variants-on-each-chromosome-v2-hd734.col.png")
knitr::include_graphics("novaseq/bam_2.1.0/vcf_3.2.0/types-of-variants-on-each-chromosome-v3-hd734.col.png")
```
...
ggscatter(HD734_var, x = "vcf2_AF", y = "vcf3_AF", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          title = "Sentieon v2.1.0  AF vs Sentieon v3.2.0 AF",
...
vcf2 = 'novaseq/bam_2.1.0/vcf_2.1.0/TMv2OCT20-HD829-1st_S33_L001_filteredmyeo.vcf'
vcf3 = 'novaseq/bam_2.1.0/vcf_3.2.0/TMv2OCT20-HD829-1st_S33_L001_filteredmyeo.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
...
## Get depths at each pos for vcf sentieon v2
vcf2_df['site'] = vcf2_df['CHROM'].astype(str) + ':' + vcf2_df['POS'].astype(str)
vcf2_df['DP'] = vcf2_df['INFO'].str.split(';').apply(
        lambda x: ''.join((y for y in x if y.startswith('DP='))))
vcf2_df['DP'] = vcf2_df['DP'].str.replace('DP=', '') # only get the numbers from DP, remove DP=

## Get depths at each pos for vcf sentieon v3
vcf3_df['site'] = vcf3_df['CHROM'].astype(str) + ':' + vcf3_df['POS'].astype(str)
vcf3_df['DP'] = vcf3_df['INFO'].str.split(';').apply(lambda x: ''.join((y for y in x if y.startswith('DP='))))
vcf3_df['DP'] = vcf3_df['DP'].str.replace('DP=', '') # only get the numbers from DP, remove DP=
vcf2_df['AF'] = vcf2_df['SAMPLE'].str.split(':', expand=True)[2]
vcf3_df['AF'] = vcf3_df['SAMPLE'].str.split(':', expand=True)[2]
...
common_sites = common_elements(vcf2_df.site,vcf3_df.site)
print("Number of Chrom:Pos sites shared between two vcfs: " + str(len(common_sites))) # 196,147

vcf2_df_common = vcf2_df.loc[vcf2_df['site'].isin(common_sites)]
vcf3_df_common = vcf3_df.loc[vcf3_df['site'].isin(common_sites)]

# rename DP in columns as we will merge soon 
vcf3_df_common = vcf3_df_common.rename({'DP': 'DP_v3'}, axis=1)
vcf2_df_common = vcf2_df_common.rename({'DP': 'DP_v2'}, axis=1)

# save common snps
vcfs_merged = pd.merge(vcf2_df_common, vcf3_df_common, on='site')
vcfs_merged.to_csv('Merged_vcfs_common.tsv', sep="\t", index=False, header=True)

#cfs_merged['DP_v3'].corr(vcfs_merged['DP_v2'])
vcfs_merged['DP_v3'] = vcfs_merged['DP_v3'].astype(int)
vcfs_merged['DP_v2'] = vcfs_merged['DP_v2'].astype(int)
...
vcf2_df_uniq = vcf2_df.loc[~vcf2_df['site'].isin(common_sites)]
vcf3_df_uniq = vcf3_df.loc[~vcf3_df['site'].isin(common_sites)]
...
```{r }
vcfsmerged = read.csv("Merged_vcfs_common.tsv", sep = "\t")
#nrow(vcfsmerged)
...
#plot(vcfsmerged$DP_v3, vcfsmerged$DP_v2)
#cor(vcfsmerged$DP_v3, vcfsmerged$DP_v2, method = c("pearson"))
library(ggplot2)
library("ggpubr")
library(grid)
library(gridExtra)
...
# get count of chromosomes occurrences
vcf2_df['AF'] = vcf2_df['SAMPLE'].str.split(':', expand=True)[2]
vcf3_df['AF'] = vcf3_df['SAMPLE'].str.split(':', expand=True)[2]

## Get site to get common/unique variants
vcf2_df['site'] = vcf2_df['CHROM'].astype(str) + ':' + vcf2_df['POS'].astype(str)
vcf3_df['site'] = vcf3_df['CHROM'].astype(str) + ':' + vcf3_df['POS'].astype(str)
...
def common_elements(list1, list2):
    return list(set(list1) & set(list2))
common_sites = common_elements(vcf3_df.site,vcf2_df.site)
...
vcf2 = 'novaseq/bam_2.1.0/vcf_2.1.0/TMv2OCT20-HD829-1st_S33_L001_filteredmyeo_goodAF.vcf'
vcf3 = 'novaseq/bam_2.1.0/vcf_3.2.0/TMv2OCT20-HD829-1st_S33_L001_filteredmyeo_goodAF.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
...
# filter the vcf3 for sites in vcf2_AF_uniq
vcf3_withvcf2uniqAF = vcf3_df.loc[vcf3_df['site'].isin(vcf2_AF_uniq.site)]

# there 25 variants carried over vcf3 with lower AF but there is 17 variants not called in sentieon v3. These are:
lowvcf2uniqAF_droppedinv3 = vcf2_AF_uniq.loc[~vcf2_AF_uniq['site'].isin(vcf3_withvcf2uniqAF.site)]
```
...
vcf2 = 'novaseq/bam_2.1.0/vcf_2.1.0/2109024-21286Z0006-BM-MPD-MYE-M-EGG2_S4_L001_filteredmyeo.vcf'
vcf3 = 'novaseq/bam_2.1.0/vcf_3.2.0/2109024-21286Z0006-BM-MPD-MYE-M-EGG2_S4_L001_filteredmyeo.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
...
#venn2(subsets = (30, 10, 5), set_labels = ('Group A', 'Group B'))
venn2(subsets = (len(vcf2_df_uniq), len(vcf3_df_uniq), len(common_sites)), set_labels = ('Sentieon v2', 'Sentieon v3'))
plt.title('2109024-21286Z0006',fontweight='bold',fontsize=20,pad=30)
plt.show()
...
vcf2 = 'novaseq/bam_2.1.0/vcf_2.1.0/2109024-21286Z0006-BM-MPD-MYE-M-EGG2_S4_L001_filteredmyeo_goodAF.vcf'
vcf3 = 'novaseq/bam_2.1.0/vcf_3.2.0/2109024-21286Z0006-BM-MPD-MYE-M-EGG2_S4_L001_filteredmyeo_goodAF.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
...
#venn2(subsets = (30, 10, 5), set_labels = ('Group A', 'Group B'))
venn2(subsets = (len(vcf2_df_uniq), len(vcf3_df_uniq), len(common_sites)), set_labels = ('Sentieon v2', 'Sentieon v3'))
plt.title('2109024-21286Z0006 AF >3%',fontweight='bold',fontsize=20,pad=30)
plt.show()
...
```{r, echo=FALSE,  out.width="50%", fig.align="default"}
knitr::include_graphics("novaseq/bam_2.1.0/vcf_2.1.0/number-of-substitutions-of-snps-v2-2109024.col.png")
knitr::include_graphics("novaseq/bam_2.1.0/vcf_3.2.0/number-of-substitutions-of-snps-v3-2109024.col.png")
```
...
```{r, echo=FALSE,  out.width="50%", fig.align="default"}
knitr::include_graphics("novaseq/bam_2.1.0/vcf_2.1.0/types-of-variants-on-each-chromosome-v2-2109024.col.png")
knitr::include_graphics("novaseq/bam_2.1.0/vcf_3.2.0/types-of-variants-on-each-chromosome-v3-2109024.col.png")
```
...
vcf2 = 'novaseq/bam_2.1.0/vcf_2.1.0/2109242-21294Z0042-BM-MPD-MYE-F-EGG2_S12_L001_filteredmyeo.vcf'
vcf3 = 'novaseq/bam_2.1.0/vcf_3.2.0/2109242-21294Z0042-BM-MPD-MYE-F-EGG2_S12_L001_filteredmyeo.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
...
#venn2(subsets = (30, 10, 5), set_labels = ('Group A', 'Group B'))
venn2(subsets = (len(vcf2_df_uniq), len(vcf3_df_uniq), len(common_sites)), set_labels = ('Sentieon v2', 'Sentieon v3'))
plt.title('2109242-21286Z0006',fontweight='bold',fontsize=20,pad=30)
plt.show()
...
plot(density(dat$AF), main = "Unique v3 variants AF 2109242-21286Z0006")
```
...
plot(density(dat$AF), main = "Unique v2 variants AF 2109242-21286Z0006")
```
...
vcf2 = 'novaseq/bam_2.1.0/vcf_2.1.0/2109242-21294Z0042-BM-MPD-MYE-F-EGG2_S12_L001_filteredmyeo_goodAF.vcf'
vcf3 = 'novaseq/bam_2.1.0/vcf_3.2.0/2109242-21294Z0042-BM-MPD-MYE-F-EGG2_S12_L001_filteredmyeo_goodAF.vcf'
cols = ["CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "SAMPLE"]
...
#venn2(subsets = (30, 10, 5), set_labels = ('Group A', 'Group B'))
venn2(subsets = (len(vcf2_df_uniq), len(vcf3_df_uniq), len(common_sites)), set_labels = ('Sentieon v2', 'Sentieon v3'))
plt.title('2109242-21286Z0006 AF >3%',fontweight='bold',fontsize=20,pad=30)
plt.show()
...
```{r, echo=FALSE,  out.width="50%", fig.align="default"}
knitr::include_graphics("novaseq/bam_2.1.0/vcf_2.1.0/number-of-substitutions-of-snps-v2-2109242.col.png")
knitr::include_graphics("novaseq/bam_2.1.0/vcf_3.2.0/number-of-substitutions-of-snps-v3-2109242.col.png")
```
...
```{r, echo=FALSE,  out.width="50%", fig.align="default"}
knitr::include_graphics("novaseq/bam_2.1.0/vcf_2.1.0/types-of-variants-on-each-chromosome-v2-2109242.col.png")
knitr::include_graphics("novaseq/bam_2.1.0/vcf_3.2.0/types-of-variants-on-each-chromosome-v3-2109242.col.png")
```
