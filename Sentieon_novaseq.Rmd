...
vcfmerged_lowvafinv3 <- vcfsmerged[which(vcfsmerged$site_ref %in% vcf3_withvcf2uniqAF_formatted$site_ref), ]
...
ggplot(vcfsmerged, aes(x = AF_v2, y = AF_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
   labs(x = "Mutect2 AF v2", y = "Mutect2 AF v3", title = "Oncospan_1st")
...
ggplot(vcf2_df, aes(x = AF_byreads_v2, y = AF_v2)) +
    ...
    geom_abline() +
    annotation_custom(grob1) + 
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v2.1.0 Oncospan_1st")
...
ggplot(vcf3_df, aes(x = AF_byreads_v3, y = AF_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v3.2.0 Oncospan_1st")
...
ggplot(vcfsmerged, aes(x = AF_byreads_v2, y = AF_byreads_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Raw AF sentieon v2", y = "Raw AF sentieon v3", title = "Oncospan_1st")
...
ggplot(vcfsmerged, aes(x = DP_v2, y = DP_v3)) +
    ...
    geom_smooth() +
    geom_abline() +
    labs(x = "DP sentieon v2", y = "DP sentieon v3", title = "Oncospan_1st") 
```
...
ggplot(vcfsmerged, aes(x = AF_v2, y = AF_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Mutect2 AF v2", y = "Mutect2 AF v3", title = "Oncospan_2nd")
...
ggplot(vcf2_df, aes(x = AF_byreads_v2, y = AF_v2)) +
    ...
    geom_abline() +
    annotation_custom(grob1) + 
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v2.1.0 Oncospan_2nd")
...
ggplot(vcf3_df, aes(x = AF_byreads_v3, y = AF_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v3.2.0 Oncospan_2nd")
...
ggplot(vcfsmerged, aes(x = AF_byreads_v2, y = AF_byreads_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Raw AF sentieon v2", y = "Raw AF sentieon v3", title = "Oncospan_2nd")
...
ggplot(vcfsmerged, aes(x = DP_v2, y = DP_v3)) +
    ...
    geom_smooth() +
    geom_abline() +
    labs(x = "DP sentieon v2", y = "DP sentieon v3", title = "Oncospan_2nd") 
```
...
ggplot(vcfsmerged, aes(x = AF_v2, y = AF_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Mutect2 AF v2", y = "Mutect2 AF v3", title = "HD734")
...
ggplot(vcf2_df, aes(x = AF_byreads_v2, y = AF_v2)) +
    ...
    geom_abline() +
    annotation_custom(grob1) + 
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v2.1.0 HD734")
...
ggplot(vcf3_df, aes(x = AF_byreads_v3, y = AF_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v3.2.0 HD734")
...
ggplot(vcfsmerged, aes(x = AF_byreads_v2, y = AF_byreads_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Raw AF sentieon v2", y = "Raw AF sentieon v3", title = "HD734")
...
ggplot(vcfsmerged, aes(x = DP_v2, y = DP_v3)) +
    ...
    geom_smooth() +
    geom_abline() +
    labs(x = "DP sentieon v2", y = "DP sentieon v3", title = "HD734") 
```
...
ggplot(vcfsmerged, aes(x = AF_x, y = AF_y)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Sentieon 2.1.0 AF", y = "Sentieon 3.2.0 AF", title = "2109024-21286Z0006")
```
...
ggplot(vcfsmerged, aes(x = AF_v2, y = AF_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Mutect2 AF v2", y = "Mutect2 AF v3", title = "2109024-21286Z0006")
...
ggplot(vcf2_df, aes(x = AF_byreads_v2, y = AF_v2)) +
    ...
    geom_abline() +
    annotation_custom(grob1) + 
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v2.1.0 2109024-21286Z0006")
...
ggplot(vcf3_df, aes(x = AF_byreads_v3, y = AF_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v3.2.0 2109024-21286Z0006")
...
ggplot(vcfsmerged, aes(x = AF_byreads_v2, y = AF_byreads_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Raw AF sentieon v2", y = "Raw AF sentieon v3 2109024-21286Z0006")
...
ggplot(vcfsmerged, aes(x = DP_v2, y = DP_v3)) +
    ...
    geom_smooth() +
    geom_abline() +
    labs(x = "DP sentieon v2", y = "DP sentieon v3", title = "2109024-21286Z0006") 
```
...
ggscatter(vcfsmerged, x = "DP_v2", y = "DP_v3", 
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.method = "pearson",
          xlab = "Sentieon 2.1.0 VCF", ylab = "Sentieon 3.2.0 VCF", title = "2109242-21286Z0006")
...
ggplot(vcfsmerged, aes(x = AF_x, y = AF_y)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Sentieon 2.1.0 AF", y = "Sentieon 3.2.0 AF", title = "2109242-21286Z0006")
```
...
ggplot(vcfsmerged, aes(x = AF_v2, y = AF_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Mutect2 AF v2", y = "Mutect2 AF v3", title = "2109242-21286Z0006")
...
ggplot(vcf2_df, aes(x = AF_byreads_v2, y = AF_v2)) +
    ...
    geom_abline() +
    annotation_custom(grob1) + 
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v2.1.0 2109242-21286Z0006")
...
ggplot(vcf3_df, aes(x = AF_byreads_v3, y = AF_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v3.2.0 2109242-21286Z0006")
...
ggplot(vcfsmerged, aes(x = AF_byreads_v2, y = AF_byreads_v3)) +
    ...
    geom_abline() +
    annotation_custom(grob1) +
  labs(x = "Raw AF sentieon v2", y = "Raw AF sentieon v3", title = "2109242-21286Z0006")
...
ggplot(vcfsmerged, aes(x = DP_v2, y = DP_v3)) +
    ...
    geom_smooth() +
    geom_abline() +
    labs(x = "DP sentieon v2", y = "DP sentieon v3", title = "2109242-21286Z0006") 
```
