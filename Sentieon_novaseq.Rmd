...
vcf2_uniqv2droppedinv3_formatted = vcf2_uniqv2droppedinv3
...
vcf2_uniqv2droppedinv3_formatted <- py$vcf2_uniqv2droppedinv3_formatted
...
cols.num <- c("AF_v2", "AF_byreads_v2" )
vcf2_uniqv2droppedinv3_formatted[cols.num] <- sapply(vcf2_uniqv2droppedinv3_formatted[cols.num],as.numeric)
...
vcf3_withvcf2uniqAF = vcf3_df.loc[vcf3_df['site_ref'].isin(vcf2_AF_uniq.site_ref)]
vcf3_withvcf2uniqAF
# there  variants carried over vcf3 with lower AF but there is 17 variants not called in sentieon v3. These are:
...
lowvcf2uniqAF_droppedinv3 = vcf3_AF_uniq.loc[~vcf3_AF_uniq['site_ref'].isin(vcf3_withvcf2uniqAF.site_ref)]
...
ggplot(vcf2_df, aes(x = AF_byreads_v2, y = AF_v2)) +
    geom_point() +
    geom_point(data=vcf2_withvcf2uniqAF_formatted, aes(x=AF_byreads_v2, y=AF_v2), colour="blue") +
    geom_point(data=lowvcf2uniqAF_droppedinv3_formatted, aes(x=AF_byreads_v3, y=AF_v3), colour="red") +
    geom_smooth() +
    geom_abline() +
    annotation_custom(grob1) + 
    labs(x = "Raw AF", y = "Mutect2 AF", title = "Sentieon v2.1.0")
...
# save common snps
vcfs_merged = pd.merge(vcf2_df_common, vcf3_df_common, on='site_red')
```
...
# theese are the variants carried over vcf3 with lower AF
lowvcf2uniqAF_droppedinv3 = vcf2_AF_uniq.loc[~vcf2_AF_uniq['site_ref'].isin(vcf3_withvcf2uniqAF.site_ref)]
```
